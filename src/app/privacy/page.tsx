    ...
    <div style={{ background: '#F7F3EE', minHeight: '100vh', fontFamily: '"Georgia", serif', color: '#1A1714' }}>
      ...
      <div style={{ maxWidth: 680, margin: '0 auto', padding: '60px 32px' }}>
        ...
        {[
          {
            title: '1. Who we are',
            body: 'Advance is an independent project based in Victoria, Australia. It is a tour management tool in active beta development. If you have any privacy questions, use our <a href="/contact">contact form</a>.',
          },
          {
          ...
          {
            title: '7. Your rights',
            body: 'You can ask us to export, correct or delete your data at any time. Just use our <a href="/contact">contact form</a> and we will sort it out promptly. If you close your account, your data is retained for 30 days in case you change your mind, then deleted.',
          },
          {
            title: '8. Cookies',
          ...
          {
            title: '10. Contact',
            body: 'For any privacy questions use our <a href="/contact">contact form</a>.',
          },
        ].map((section, i) => (
