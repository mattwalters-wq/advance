      ...
      <div style={{ maxWidth: 680, margin: '0 auto', padding: '60px 32px' }}>
        ...
        {[
          ...
          },
          {
            ...
            body: 'You are responsible for keeping your login details secure and for anything that happens under your account. Please use a strong password. If you think someone else has access to your account, contact us via our <a href="/contact">contact form</a> straight away.',
          },
          {
            title: '3. Your data',
            body: 'The tour data, contacts, documents and notes you add belong to you. We store them securely to make the product work, but we have no claim over your content. You can request a copy or deletion of your data at any time by using our <a href="/contact">contact form</a>.',
          },
          {
          ...
          },
          {
            ...
            body: 'Questions, concerns, feedback or just want to say hello? Use our <a href="/contact">contact form</a>.',
          },
        ].map((section, i) => (
